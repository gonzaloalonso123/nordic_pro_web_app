...
export const useUpdateOrganisation = (
  ...
  return useMutation<OrganisationRow, Error, { organisationId: string; updates: OrganisationUpdate }>({
    ...
    onSuccess: (data, variables, context) => {
      queryClient.invalidateQueries({ queryKey: ["organisations"] })
      queryClient.invalidateQueries({ queryKey: ["organisations", variables.organisationId] })
      queryClient.invalidateQueries({ queryKey: ["organisations", variables.organisationId, "teams"] })
      queryClient.invalidateQueries({ queryKey: ["organisations", variables.organisationId, "users"] })
      queryClient.invalidateQueries({ queryKey: ["organisations", variables.organisationId, "calendar"] })
      options?.onSuccess?.(data, variables, context)
    },
    ...options,
  })
