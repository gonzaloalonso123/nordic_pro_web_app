  ...
  return (
    <Content>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left column - Experience and level */}
        <div className="lg:col-span-1">
          <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200 overflow-hidden mb-6">
            <CardHeader className="pb-2 relative">
              ...
              <CardDescription>Level up by completing forms</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="bg-gradient-to-r from-indigo-100/50 to-purple-100/50 border-t border-indigo-200">
              <div className="text-xs text-muted-foreground">
                <span className="font-medium text-indigo-700">
                  Next level in:{" "}
                </span>
                {nextLevelXp - experience} XP
              </div>
            </CardFooter>
          </Card>
        ...
        {/* Middle and right columns - Next form and trophies */}
              ...
              <div className="space-y-4">
                {nextForms.map((form, index) => (
                  ...
                  >
                    <Card
                      className={
                        index === 0 ? "border-2 border-amber-300 shadow-lg" : ""
                      }
                    >
                      {index === 0 && (
                        <div className="bg-amber-100 text-amber-800 text-xs font-medium px-3 py-1 rounded-t-md w-fit ml-4 -mt-2 border border-amber-300 border-b-0">
                          RECOMMENDED
                        </div>
                      )}
                      ...
                      <CardContent>
                        <div className="flex flex-wrap gap-2 text-sm">
                          ...
                          >
                            ...
                            {form.completionRate}% completion rate
                          </Badge>
                        </div>
                      </CardContent>
                      <CardFooter className="flex justify-between bg-gray-50 border-t">
                        <div className="text-xs text-muted-foreground">
                          Complete this form to earn experience and trophies!
                        </div>
                        <Button
                          size="sm"
                          className={
      ...
      {/* Bottom section - Upcoming forms or challenges */}
      <div className="mt-8">
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          ...
          <CardFooter className="bg-blue-100/50 border-t border-blue-200">
            <Button
              variant="outline"
              className="w-full"
